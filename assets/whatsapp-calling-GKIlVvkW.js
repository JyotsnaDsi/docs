...
WhatsApp Calling supports SIP (Session Initiation Protocol) as the signaling protocol for voice communication.`,i=[{depth:1,text:`WhatsApp Business Calling API Integration`,id:`whatsapp-business-calling-api-integration`,children:[{depth:2,text:`Introduction`,id:`introduction`},{depth:2,text:`Setup`,id:`setup`,children:[{depth:3,text:`Prerequisites and Account Setup`,id:`prerequisites-and-account-setup`},{depth:3,text:`Account Requirements`,id:`account-requirements`},{depth:3,text:`Application Requirements`,id:`application-requirements`}]},{depth:2,text:`User-Initiated Calls`,id:`user-initiated-calls`,children:[{depth:3,text:`Configuration Steps`,id:`configuration-steps`},{depth:3,text:`Example API Request`,id:`example-api-request`}]},{depth:2,text:`Business-Initiated Calls`,id:`business-initiated-calls`,children:[{depth:3,text:`Requirements`,id:`requirements`}]},{depth:2,text:`References`,id:`references`}]}],a={lastModifiedTime:`2026-07-15T11:00:53.000Z`},o=`pages/iravoice/whatsapp-calling.mdx`;function s(e){let r={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,hr:`hr`,li:`li`,note:`note`,ol:`ol`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,ul:`ul`,...t(),...e.components},{Stepper:i}=r;return i||l(`Stepper`,!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h1,{id:`whatsapp-business-calling-api-integration`,children:`WhatsApp Business Calling API Integration`}),`
...
//# sourceMappingURL=whatsapp-calling-GKIlVvkW.js.map