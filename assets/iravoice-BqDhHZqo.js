import{t as e}from"./jsx-runtime-BFqoZbY3.js";import{n as t}from"./lib-G-RPdD_e.js";var n=e(),r=`The Epicode Sandbox environment is provided to help customers safely test and validate their integration before moving to production.`,i=[{depth:1,text:`IraVoice Sandbox`,id:`iravoice-sandbox`,children:[{depth:2,text:`Access Details`,id:`access-details`},{depth:2,text:`Making a test call for IraVoice`,id:`making-a-test-call-for-iravoice`},{depth:2,text:`Key configurations`,id:`key-configurations`,children:[{depth:3,text:`Media Stream Format`,id:`media-stream-format`},{depth:3,text:`Streaming Modes`,id:`streaming-modes`},{depth:3,text:`Codecs Supported by IraVoice in the Sandbox`,id:`codecs-supported-by-iravoice-in-the-sandbox`}]},{depth:2,text:`Making an inbound call in Iravoice`,id:`making-an-inbound-call-in-iravoice`},{depth:2,text:`Frequently Asked questions`,id:`frequently-asked-questions`}]}],a={lastModifiedTime:`2026-07-14T05:23:57.000Z`},o=`pages/sandbox/iravoice.mdx`;function s(e){let r={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,hr:`hr`,li:`li`,note:`note`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,tip:`tip`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h1,{id:`iravoice-sandbox`,children:`IraVoice Sandbox`}),`
...
`,(0,n.jsxs)(r.li,{children:[`Refer to the `,(0,n.jsx)(r.a,{href:`/iravoice/websocket-message-model`,children:(0,n.jsx)(r.strong,{children:`Websocket Message Model`})}),` for integrating your voicebot application with IraVoice.`]}),`
`,(0,n.jsxs)(r.li,{children:[`More details on `,(0,n.jsx)(r.strong,{children:`Make Call request parameters`}),`: `,(0,n.jsx)(r.a,{href:`/api/makecall-make-outbound-call`,children:(0,n.jsx)(r.strong,{children:`Call Params`})})]}),`
`]}),`
`,(0,n.jsx)(r.tip,{children:(0,n.jsxs)(r.p,{children:[`Sample websocket code for payload structure: `,(0,n.jsx)(r.a,{href:`https://drive.google.com/file/d/1n_dXpTgm5BNImtT1gWIWic6H4eDzNHHv/view?usp=sharing`,children:(0,n.jsx)(r.strong,{children:`websocket_script`})})]})}),`
`,(0,n.jsx)(r.h2,{id:`key-configurations`,children:`Key configurations`}),`
`,(0,n.jsx)(r.h3,{id:`media-stream-format`,children:`Media Stream Format`}),`
`,(0,n.jsx)(r.p,{children:`The voicebot application must stream audio to IraVoice over WebSocket in PCM (signed 16-bit) format`}),`
`,(0,n.jsx)(r.hr,{}),`
`,(0,n.jsx)(r.h3,{id:`streaming-modes`,children:`Streaming Modes`}),`
`,(0,n.jsxs)(r.p,{children:[(0,n.jsx)(r.strong,{children:`VAD Mode`}),` ("streaming_useraudio": false):`]}),`
`,(0,n.jsxs)(r.ul,{children:[`
...
`]}),`
`,(0,n.jsxs)(r.p,{children:[(0,n.jsx)(r.strong,{children:`Non-VAD Mode`}),` ("streaming_useraudio": true):`]}),`
`,(0,n.jsxs)(r.ul,{children:[`
...
`]}),`
`,(0,n.jsx)(r.hr,{}),`
`,(0,n.jsx)(r.h3,{id:`codecs-supported-by-iravoice-in-the-sandbox`,children:`Codecs Supported by IraVoice in the Sandbox`}),`
`,(0,n.jsxs)(r.ul,{children:[`
