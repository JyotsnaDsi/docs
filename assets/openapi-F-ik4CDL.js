const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./createServer-B1ASg0_e.js","./chunk-CilyBKbf.js","./preload-helper-Chd9yIcd.js","./constants-MJw1ofWZ.js","./slugify-DxorHtDJ.js","./OasProvider-BTkr97w7.js","./joinUrl-crFTJinF.js","./useBaseQuery-Df4wM-4M.js","./jsx-runtime-BFqoZbY3.js","./react-C7HJXoYM.js","./OperationList-hItxslgm.js","./react-nprogress.esm-CVfNXy08.js","./dist-DLiUA7QY.js","./Button-C2Y51aF1.js","./dist-C1Byffx-.js","./cn-GHoLcEO7.js","./Textarea-Bx4fxaWV.js","./DropdownMenu-4FR3KDii.js","./dist-BkKfojYu2.js","./es2015-BW_TYL9d.js","./createLucideIcon-Da3dwJUI.js","./useQuery-Dc4HV5Mo.js","./utils-DuHXVRey.js","./Dialog-CxXvfOMi.js","./x-DcPCpimz.js","./PlaygroundDialog-C4iZ5H3P.js","./Select-CNCJidl2.js","./dist-tl1SPy0O.js","./copy-DmtCOk43.js","./Popover-BwbZ3Nnx.js","./Markdown-COPf8mz9.js","./lib-G-RPdD_e.js","./shiki-CJD3shTg.js","./lib-Jni5Jb6u.js","./shiki-constants-D7BS3I4F.js","./Typography-BUfzj9wv.js","./useHighlighter-eMrzT5__.js","./eye-off-BbMp2iBl.js","./Collapsible-qT_XLUD5.js","./Card-C7apEtoc.js","./dist-DHNgg_tJ.js","./shield-check-B-Q6WIwv.js","./Alert-BCtrOnrQ.js","./SyntaxHighlight-B9BvINui.js","./CodeBlock-57KApmPg.js","./useCopyToClipboard-CkQRkHmQ.js","./CategoryHeading-CAcbeXwK.js","./dist-By8TAgdj.js","./Pagination-D3sgsiVQ.js","./SchemaView-43cSPr0N.js","./Badge-DyvEyv0g.js","./InlineCode-DrSTYVBl.js","./Item-BBowNmr7.js","./AiAssistantMenuItems-C1p5mCIL.js","./Callout-DiNAcgVI.js","./useWarmupSchema-DMt6rXOp.js","./SchemaList-DRsytQOP.js","./Toc-CrXnCC7Y.js","./useScrollToAnchor-BQZoMPt_.js","./SchemaInfo-C1R4t8ta.js","./webhook-BRMPpFla.js","./PlaygroundDialog-uZ2tb9PW.js"])))=>i.map(i=>d[i]);
import{r as e}from"./chunk-CilyBKbf.js";import{t}from"./react-C7HJXoYM.js";import{t as n}from"./preload-helper-Chd9yIcd.js";import{_ as r,a as i,f as a,m as o,n as s,t as c,u as l,x as u}from"./joinUrl-crFTJinF.js";import{t as d}from"./jsx-runtime-BFqoZbY3.js";import{t as f}from"./createLucideIcon-Da3dwJUI.js";import{t as p}from"./Button-C2Y51aF1.js";var m=f(`circle-play`,[[`path`,{d:`M9 9.003a1 1 0 0 1 1.517-.859l4.997 2.997a1 1 0 0 1 0 1.718l-4.997 2.997A1 1 0 0 1 9 14.996z`,key:`kmsa83`}],[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}]]),h=class extends Error{developerHint;title;constructor(e,{developerHint:t,title:n,cause:r}={}){super(e,{cause:r}),this.name=`ZudokuError`,this.title=n,this.developerHint=t}},g,_={},v=e=>{if(e.errors?.[0])throw new h(e.errors[0].message,{developerHint:"Check your configuration value `apis.type` and `apis.input` in the Zudoku config."})},y=class{config;constructor(e){e.schemaImports&&Object.assign(_,e.schemaImports),this.config=e}#e=async()=>(g||=n(()=>import(`./createServer-B1ASg0_e.js`).then(e=>e.createServer({...this.config,schemaImports:_})),__vite__mapDeps([0,1,2,3,4]),import.meta.url),g);#t=async e=>this.config.server?fetch(this.config.server,e):(await this.#e()).fetch(`http://localhost/graphql`,e);fetch=async(e,t)=>{let n=e.match(/query (\w+)/)?.[1],r=await this.#t({method:`POST`,body:JSON.stringify({query:e,variables:t,operationName:n}),headers:{"Content-Type":`application/json`}});if(!r.ok)throw Error(`Network response was not ok`);let i=await r.json();return v(i),i.data}},b=e(t(),1),x=d(),S=(0,b.createContext)(void 0),C=({children:e,client:t})=>(0,x.jsx)(S.Provider,{value:t,children:e}),w=(e,t,...[n])=>({queryFn:()=>e.fetch(t,n),queryKey:[t.toString().replace(/\s+/g,` `).trim(),n]}),T=(e,...[t])=>{let n=(0,b.use)(S);if(n===void 0)throw Error(`useGraphQL must be used within a GraphQLProvider`);return w(n,e,...t===void 0?[]:[t])},E=class extends String{__apiType;value;__meta__;constructor(e,t){super(e),this.value=e,this.__meta__=t}toString(){return this.value}},D=new E(`
