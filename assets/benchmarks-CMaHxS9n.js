import{t as e}from"./jsx-runtime-BFqoZbY3.js";import{n as t}from"./lib-G-RPdD_e.js";var n=e(),r=`Answering Machine Detection (AMD) is a technology used with dialers to identify calls answered by voicemail systems instead of a live person. The objective is to quickly determine whether the call has been answered by:`,i=[{depth:1,text:`IraCPA Machine Detection and Accuracy`,id:`iracpa-machine-detection-and-accuracy`,children:[{depth:2,text:`Answering Machine Detection (AMD)`,id:`answering-machine-detection-amd`},{depth:2,text:`IraCPA Module`,id:`iracpa-module`},{depth:2,text:`Voicemail Beep Detection`,id:`voicemail-beep-detection`},{depth:2,text:`Handling Early Answer Events`,id:`handling-early-answer-events`},{depth:2,text:`Benchmarks`,id:`benchmarks`}]}],a={lastModifiedTime:`2026-07-15T11:43:05.000Z`},o=`pages/iracpa/benchmarks.mdx`;function s(e){let r={h1:`h1`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h1,{id:`iracpa-machine-detection-and-accuracy`,children:`IraCPA Machine Detection and Accuracy`}),`
...
`,(0,n.jsx)(r.h2,{id:`iracpa-module`,children:`IraCPA Module`}),`
...
//# sourceMappingURL=benchmarks-CMaHxS9n.js.map