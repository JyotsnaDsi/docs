import{t as e}from"./jsx-runtime-BFqoZbY3.js";import{n as t}from"./lib-Fyu0Mufw.js";var n=e(),r=`The Epicode Sandbox environment is provided to help customers safely test and validate their integration before moving to production.`,i=[{depth:1,text:`IraVoice Sandbox Environment`,id:`iravoice-sandbox-environment`,children:[{depth:2,text:`Access Details`,id:`access-details`},{depth:2,text:`Making a test call for IraVoice`,id:`making-a-test-call-for-iravoice`,children:[{depth:3,text:`Key configurations:`,id:`key-configurations`}]},{depth:2,text:`Making an inbound call in Iravoice`,id:`making-an-inbound-call-in-iravoice`,children:[{depth:3,text:`Frequently Asked questions`,id:`frequently-asked-questions`}]}]}],a={lastModifiedTime:`2026-05-26T13:22:48.000Z`},o=`pages/sandbox/iravoice.mdx`;function s(e){let r={a:`a`,br:`br`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,info:`info`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,tip:`tip`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h1,{id:`iravoice-sandbox-environment`,children:`IraVoice Sandbox Environment`}),`
...
`,(0,n.jsx)(r.info,{children:(0,n.jsxs)(r.p,{children:[(0,n.jsx)(r.strong,{children:`BASE_URL`}),`: `,(0,n.jsx)(r.a,{href:`https://sandboxld.epicode.in/api/`,children:`https://sandboxld.epicode.in/api/`})]})}),`
`,(0,n.jsx)(r.info,{children:(0,n.jsx)(r.p,{children:(0,n.jsxs)(r.strong,{children:[(0,n.jsx)(r.a,{href:`/api`,children:`Click here`}),` for IraVoice API documentation`]})})}),`
...
//# sourceMappingURL=iravoice-BWaaSeZZ.js.map